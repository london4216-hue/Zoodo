...
const SUBJECT_GUIDE = {
  ...
  'Stretch time': 'Target: gentle indoor stretching and body awareness. Use simple, slow movement vocabulary (reach up high, touch your toes, stretch your arms, wiggle). Teach one stretch with I-do/we-do/you-do ("watch me reach up high... together... your turn!"). Keep it calm and indoor. Set letter/sound to "" and word to the key body part if there is one.',
